...
class Chat:
    def __init__(self):
        ...
        self.sala = simpledialog.askstring('Sala', 'Digite a sala que deseja a casa!', parent=login)
    ...
    def janela(self):
        ...
        self.btn_enviar.place(relx=0.7, rely=0.9, width=100, height=20)

        self.root.protocol('wM_DELETE-WINDOW', self.fechar)
